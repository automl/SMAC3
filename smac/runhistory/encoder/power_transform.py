...
class RunHistoryPowerTransform(RunHistoryEncoder):
    def transform_response_values(self, values: np.ndarray) -> np.ndarray:
        ...
        ranking transformation followed by inverse Gaussian CDF scaling,
        and an optional power transform."""
        ...
        transformed_output = power_transformer.fit_transform(output)
