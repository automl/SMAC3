...
@note: example call: python src/generic_wrapper/spearWrapper.py \
                        --runsolver ./target_algorithms/runsolver/runsolver-3.3.4/src/runsolver \
                        -- <instance> <instance specific> <cutoff> <runlength> <seed>
...
class AbstractWrapper(object):
    ...
    def __init__(self):
        ...
        self._program_license = '''%s
          ...
          USAGE
        ''' % (program_shortdesc, str(__authors__), str(__date__), program_version_message)
    ...
    def main(self, argv=None):
        ...
        try:
            ...
            self.parser.add_argument("--internal", dest="internal",
                                     default=False,
                                     type=bool,
            ...
            self.parser.add_argument("--ext-callstring", dest="ext_callstring",
                                     default=None,
            ...
            self.parser.add_argument("--ext-parsing", dest="ext_parsing",
                                     default=None,
                                     help="""Command to use an external program to parse the output of your target algorihm;
                                             ...
                                             quality: <integer>
                                             misc: <string>""")
            self.parser.add_argument("--help", dest="show_help",
                                     default=False,
                                     type=bool,
                                     help="shows help")
            ...
            if args.ext_callstring:
                target_cmd = self.get_command_line_args_ext(runargs=runargs,
            ...
            if args.ext_parsing:
                resultMap = self.process_results_ext(self._solver_file,
    ...
    def print_result_string(self):
        ...
        sys.stdout.write("Result for ParamILS: %s, %s, %s, %s, %s"
                         % (self._ta_status, str(self._ta_runtime), str(self._ta_runlength),
                            str(self._ta_quality), str(self._seed)))
    ...
    def cleanup(self):
        ...
        if (len(self._subprocesses) > 0):
            ...
            try:
                ...
                self.print_d("done... If anything in the subprocess tree fork'd a new process group"
