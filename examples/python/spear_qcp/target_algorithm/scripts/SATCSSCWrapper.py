...
python -O SATCSSCWrapper.py \
    --script ./cssc_wrapper/spearCSSCWrapper.py
    --runsolver-path ../../target_algorithms/runsolver/runsolver \
    -- ../../instances/sat/data/SWV-Calysto/SWV-Calysto/DSPAM_v3.6.5__v1.1/dspam_vc9625.cnf "" 30.0 2147483647 1234 \
    -sp-var-dec-heur 16 \
    -sp-learned-clause-sort-heur 5 \
    -sp-orig-clause-sort-heur 8 \
    -sp-res-order-heur 5 \
    -sp-clause-del-heur 2 \
    -sp-phase-dec-heur 1 \
    -sp-resolution 1 \
    -sp-variable-decay 2 \
    -sp-clause-decay 1.3 \
    -sp-restart-inc 1.9 \
    -sp-learned-size-factor 0.136079 \
    -sp-learned-clauses-inc 1.1 \
    -sp-clause-activity-inc 1.0555555555555556 \
    -sp-var-activity-inc 1.2777777777777777 \
    -sp-rand-phase-dec-freq 0.0010 \
    -sp-rand-var-dec-freq 0.0010 \
    -sp-rand-var-dec-scaling 1.1 \
    -sp-rand-phase-scaling 1 \
    -sp-max-res-lit-inc 2.3333333333333335 \
    -sp-first-restart 43 \
    -sp-res-cutoff-cls 4 \
    -sp-res-cutoff-lits 1176 \
    -sp-max-res-runs 3 \
...
python -O SATCSSCWrapper.py \
    --sat-checker ./cssc_wrapper/SAT/SAT \
    --sol-file ./test.txt  \
    --script ./cssc_wrapper/spearCSSCWrapper.py \
    --runsolver-path ../../target_algorithms/runsolver/runsolver
    -- ../../instances/sat/data/SWV-Calysto/SWV-Calysto/DSPAM_v3.6.5__v1.1/dspam_vc9625.cnf "" 30.0 2147483647 1234 \
