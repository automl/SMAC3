    ...
    def test_get_next_run_wait(self):
        ...
        with unittest.mock.patch(
            ...
            intent, run_info = scheduler.get_next_run(
                challengers=None, incumbent=None, chooser=None, run_history=None, repeat_configs=False, num_workers=1
            )
    ...
    def test_get_next_run_add_instance(self):
        ...
        with unittest.mock.patch(
            ...
            def instance_added(args):
                ...
                scheduler.intensifier_instances[source_id].get_next_run.return_value = (RunInfoIntent.RUN, None)
                return True
