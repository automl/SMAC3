...
class TrajLoggerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = Configuration(
            self.cs, {"param_a": 0.5, "param_b": 1, "param_c": "value", "ambigous_categorical": 5}
        )
    ...
    def test_add_entries(self, mock_stats):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            mock_stats.ta_time_used = 0
            tl.add_entry(
                0.7, 2, Configuration(self.cs, dict(self.test_config.get_dictionary(), **{"param_a": 0.0})), 10
            )
        ...
        self.assertEqual(frmt_str % 0.7, data[2][1])
        self.assertEqual(frmt_str % 3, data[2][4])

        # Check aclib2-format
        self.assertEqual(json_dicts_aclib2[0]["cpu_time"], 0.5)
        ...
        self.assertEqual(json_dicts_alljson[0]["cpu_time"], 0.5)
    ...
    def test_ambigious_categoricals(self, mock_stats):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            problem_config = Configuration(
                self.cs, {"param_a": 0.0, "param_b": 2, "param_c": "value", "ambigous_categorical": True}
