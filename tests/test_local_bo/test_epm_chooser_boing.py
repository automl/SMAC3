...
from smac.optimizer.configuration_chooser.boing_chooser import BOinGChooser, subspace_extraction
...
class TestEPMChooserBOinG(unittest.TestCase):
    ...
    def test_do_switching(self):
        ...
        with unittest.mock.patch("smac.optimizer.local_bo.epm_chooser_boing.EPMChooserBOinG.restart_TuRBOinG") as mk:
            next(epm_chooser.choose_next())
