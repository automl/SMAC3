...
from smac.optimizer.local_bo.rh2epm_boing import RunHistory2EPM4CostWithRaw, RunHistory2EPM4ScaledLogCostWithRaw

from test.test_runhistory.test_runhistory2epm import RunhistoryTest


class TestRH2EPMBOinG(RunhistoryTest):
    def test_cost_without_imputation(self):
        rh2epm_kwargs = dict(num_params=2,
