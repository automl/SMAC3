...
class TaeTest(unittest.TestCase):
    ...
    def test_start_tae_return_abort(self, test_run):
        ...
        _, run_value = eta.run_wrapper(
            RunInfo(config=None, instance=1, instance_specific=None, cutoff=30, seed=None, capped=False, budget=0.0)
        )
    ...
    def test_start_tae_return_nan_inf(self, test_run):
        ...
        def get_tae(obj):
            ...
            scen = Scenario(
                scenario={"cs": ConfigurationSpace(), "run_obj": obj, "cutoff_time": "10"}, cmd_options=None
            )
            stats = Stats(scen)
            stats.start_timing()
        ...
        run_info, result = eta.run_wrapper(
            RunInfo(config={}, instance=1, instance_specific="0", cutoff=10, seed=None, capped=False, budget=0.0)
        )
    ...
    def test_crashed_cost_value(self, test_run):
        ...
        run_info, result = eta.run_wrapper(
            RunInfo(config={}, instance=1, instance_specific="0", cutoff=None, seed=None, capped=False, budget=0.0)
        )
        ...
        run_info, result = eta.run_wrapper(
            RunInfo(config={}, instance=1, instance_specific="0", cutoff=20, seed=None, capped=False, budget=0.0)
        )
