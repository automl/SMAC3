...
class ScenarioTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_scenario_dict = {'algo': 'echo Hello',
                                   'paramfile': '../../test_files/scenario_test/param.pcs',
                                   'execdir': '.',
                                   'deterministic': 0,
                                   'run_obj': 'runtime',
                                   'overall_obj': 'mean10',
                                   ...
                                   'instance_file': '../../test_files/scenario_test/training.txt',
                                   'test_instance_file': '../../test_files/scenario_test/test.txt',
                                   'feature_file': '../../test_files/scenario_test/features.txt'}
