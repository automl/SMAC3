...
from smac.optimizer.local_bo.abstract_subspace import ChallengerListLocal
...
class TestBOinGSubspace(unittest.TestCase):
    ...
    def test_init(self):
        ...
        acq_optimiozer = LocalAndSortedRandomSearch(acquisition_function=None, config_space=self.cs,
                                                    n_steps_plateau_walk=10, n_sls_iterations=10)

        boing_ss_2 = BOinGSubspace(**self.ss_kwargs,
                                   acq_optimizer_local=acq_optimiozer)
    ...
    def test_generate_challangers(self):
        ...
        boing_ss = BOinGSubspace(**self.ss_kwargs,
