...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /home/numina/Documents/repos/SMAC3/examples/1_basics/4_callback.py:57: DeprecationWarning: Please use `dict(config)` instead of `config.get_dictionary()` or use it as a dictionary directly if needed.
