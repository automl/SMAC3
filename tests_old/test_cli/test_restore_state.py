...
class TestSMACCLI(unittest.TestCase):
    ...
    def test_illegal_input(self):
        ...
        smac = AlgorithmConfigurationFacade(scen, stats=stats, rng=np.random.RandomState(42))
        ...
        smac = AlgorithmConfigurationFacade(scen, restore_incumbent=incumbent, rng=np.random.RandomState(42))
        self.assertRaises(ValueError, smac.optimize)
