...
class RunhistoryTest(unittest.TestCase):
    ...
    def test_log_runtime_with_imputation(self):
        ...
        self.assertTrue(np.allclose(y, np.array([[0.0]])))  # 10^0 = 1
        ...
        X, y = rh2epm.transform(self.rh)
        self.assertTrue(np.allclose(X, np.array([[0.005, 0.995], [0.995, 0.995]]), atol=0.001))
        # ln(20 * 10)
        self.assertTrue(np.allclose(y, np.array([[0.0], [5.2983]]), atol=0.001))
    ...
    def test_cost_with_imputation(self):
        ...
        X, y = rh2epm.transform(self.rh)
        self.assertTrue(np.allclose(X, np.array([[0.005, 0.995]]), atol=0.001))
        self.assertTrue(np.allclose(y, np.array([[1.0]])))
    ...
    def test_cost_without_imputation(self):
        ...
        # log_10(20 * 10)
        np.testing.assert_allclose(y, np.array([[1.0], [200.0]]), atol=0.001)
    ...
    def test_get_X_y(self):
        ...
        X_sol = np.array([[0, 100, 1, 1], [0, 100, 2, 2], [100, 0, 1, 1], [100, 0, 2, 2]])
