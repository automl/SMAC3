...
from smac.algorithm_executer.algorithm_executer import ExecuteTAFuncArray, AlgorithmExecuter
...
class TestExecuteFunc(unittest.TestCase):
    ...
    def test_memout(self):
        ...
        if platform == "linux":
            ...
            raise ValueError("Test cannot be performed on platform %s" % sys.platform)
