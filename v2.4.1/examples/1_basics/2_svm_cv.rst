...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /Users/lukasfehring/Desktop/library-development/SMAC3/examples/1_basics/2_svm_cv.py:57: DeprecationWarning: Please use `dict(config)` instead of `config.get_dictionary()` or use it as a dictionary directly if needed.
