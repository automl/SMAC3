...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [INFO][abstract_intensifier.py:595] Added config 468dc7 and rejected config 9c0078 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 124616 and rejected config 468dc7 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config a0bfbc and rejected config 124616 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 6efddc and rejected config a0bfbc as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 4d8d84 and rejected config 6efddc as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config ebdfd3 and rejected config 4d8d84 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config f53365 and rejected config ebdfd3 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 3518bc and rejected config f53365 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 23db2d and rejected config 3518bc as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 799518 and rejected config 23db2d as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][smbo.py:320] Finished 50 trials.
    [INFO][abstract_intensifier.py:595] Added config 1e68af and rejected config 799518 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config abd634 and rejected config 1e68af as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config e30fdc and rejected config abd634 as incumbent because it is not better than the incumbents on 1 instances:
