...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [INFO][abstract_intensifier.py:595] Added config 39e84e and rejected config 568310 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config ee9f94 and rejected config 39e84e as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 829640 and rejected config ee9f94 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 9b4b2f and rejected config 829640 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][smbo.py:320] Finished 100 trials.
    [INFO][abstract_intensifier.py:595] Added config be47cd and rejected config 9b4b2f as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 5da2d8 and rejected config be47cd as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][smbo.py:320] Finished 150 trials.
    [INFO][abstract_intensifier.py:595] Added config d02b38 and rejected config 5da2d8 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][smbo.py:320] Finished 200 trials.
    [INFO][abstract_intensifier.py:595] Added config 6404f2 and rejected config d02b38 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config edd65b and rejected config 6404f2 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config e28fe6 and rejected config edd65b as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config db091f and rejected config e28fe6 as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 9bea37 and rejected config db091f as incumbent because it is not better than the incumbents on 1 instances:
    ...
    [INFO][abstract_intensifier.py:306] Using only one seed for deterministic scenario.
    Default cost: 50.0
    Incumbent cost: 1.0919630444625126e-09
...
.. only:: html
  ...
  .. container:: sphx-glr-footer sphx-glr-footer-example
    ...
    .. container:: sphx-glr-download sphx-glr-download-zip
      ...
      :download:`Download zipped: 3_specify_HB_via_total_budget.zip <3_specify_HB_via_total_budget.zip>`
