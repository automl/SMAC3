...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    [INFO][smbo.py:329] --- Remaining wallclock time: 6.664504766464233
    [INFO][smbo.py:330] --- Remaining cpu time: inf
    [INFO][smbo.py:331] --- Remaining trials: -5
    ...
    /opt/anaconda3/envs/smac-dev/lib/python3.10/site-packages/distributed/node.py:187: UserWarning: Port 8787 is already in use.
    Perhaps you already have a cluster running?
    Hosting the HTTP server on port 65131 instead
      warnings.warn(
    [INFO][abstract_initial_design.py:147] Using 5 initial design configurations and 0 additional configurations.
    [INFO][successive_halving.py:164] Successive Halving uses budget type BUDGETS with eta 3, min budget 1, and max budget 25.
    [INFO][successive_halving.py:323] Number of configs in stage:
    ...
    [INFO][smbo.py:320] Finished 0 trials.
    [INFO][smbo.py:320] Finished 0 trials.
    [INFO][abstract_intensifier.py:516] Added config f8a1bf as new incumbent because there are no incumbents yet.
    [INFO][abstract_intensifier.py:595] Added config ce1b60 and rejected config f8a1bf as incumbent because it is not better than the incumbents on 1 instances:
    [INFO][abstract_intensifier.py:595] Added config 990a19 and rejected config ce1b60 as incumbent because it is not better than the incumbents on 1 instances:
    ...
    [INFO][smbo.py:320] Finished 200 trials.
    [INFO][smbo.py:328] Configuration budget is exhausted:
    [INFO][smbo.py:329] --- Remaining wallclock time: 15.220245599746704
    [INFO][smbo.py:330] --- Remaining cpu time: inf
    [INFO][smbo.py:331] --- Remaining trials: -3
    Default cost (Hyperband): 0.36672856700711853
    Incumbent cost (Hyperband): 0.021149798823893562
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 45.552 seconds)
