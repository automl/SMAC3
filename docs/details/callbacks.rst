...
1. Implement a callback class in ``smac/callbacks.py``. There are no restrictions on how such a
...
2. Add your callback to ``smac.smbo.optimizer.SMBO._callbacks``, using the name of your callback
as the key, and an empty list as the value.
3. Add your callback to ``smac.smbo.optimizer.SMBO._callback_to_key``, using the callback class as
