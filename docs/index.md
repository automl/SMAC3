...
SMAC3 is written in Python3 and continuously tested with Python 3.9, and 3.10. Its Random Forest is written in C++. In the following, SMAC is representatively mentioned for SMAC3.
