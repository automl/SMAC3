.. note::
    ...
    Click :ref:`here <sphx_glr_download_pages_examples_python_synthetic_function.py>` to download the full example code
.. rst-class:: sphx-glr-example-title

.. _sphx_glr_pages_examples_python_synthetic_function.py:
...
.. _sphx_glr_download_pages_examples_python_synthetic_function.py:
